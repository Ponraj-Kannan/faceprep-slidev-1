...
<div class="box1">
  <div class="box2">
    <h2 class="box3">Data Types & Variables</h2>
    <img src="../assets/logo.png"/>
  </div>

  <div class="box4" style="margin-top:0px">
    <div v-click class="box5" style="padding-top: 20px; font-weight: 500;">Practice Problem</div>
    <div v-click class="box5" style="padding-top: 0px;">
    <div class="mini-container">Swap the values of two integer variables <b>A</b> and <b>B</b> using a <b>temporary variable</b>.</div>
    </div>
    <div v-click></div>
