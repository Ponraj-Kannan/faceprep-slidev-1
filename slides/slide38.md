...
<div class="box1">
  <div class="box2">
    <h2 class="box3">Widening Casting</h2>
  ...
  <div class="box4" style="margin-top:20px">
   ...
   <div class="container2">
    <div v-click class="mini-container">Convert a given int value 147 to float.</div>
    <div v-click class="mini-container">Convert a given byte value 89 to int.</div>
    <div v-click class="mini-container">Convert a given float value 45.6f to double.</div>
    <div v-click class="mini-container">Convert a given char value 'M' to int.</div>
   </div>
  </div>
</div>
