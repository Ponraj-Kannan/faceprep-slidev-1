...
<div class="box1">
  ...
  <div class="box4" style="margin-top:10px">
    <div v-click class="box5" style="padding-top: 20px; color: #ef5050ff; font-weight: 700;">Java Multi-line Comments</div>
    <div v-click class="box5" style="padding-top: 0px;">* Multi-line comments <span v-mark.red="3">start with /* and ends with */</span>.</div>
    <div v-click></div>
