  ...
  <div class="box6" >
    <div class="box7" >
      <div v-click class="box8">
        ...
        <div style="font-size: .7rem; font-weight: 500; color:#464646ff; margin-top:10px;">Everything is modeled as classes and objects — data + behavior together.</div>
      </div>
      <div v-click class="box8" style="width: 550px">
        ...
        <div style="font-size: .7rem; font-weight: 500; color:#464646ff; margin-top:10px;">Every variable must have a declared type — errors caught early at compile time.</div>
      </div>
      <div v-click class="box8" >
        ...
        <div style="font-size: .7rem; font-weight: 500; color:#464646ff; margin-top:10px;">Compile once to bytecode — the JVM runs it on Windows, Mac, or Linux.</div>
      </div>
      <div v-click class="box8" >
        ...
        <div style="font-size: .7rem; font-weight: 500; color:#464646ff; margin-top:10px;">Java handles memory automatically — no manual free() calls needed.</div>
      </div>
    </div>
  </div>
</div>
