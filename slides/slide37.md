...
<div class="box1">
  <div class="box2">
    <h2 class="box3">Narrowing Casting</h2>
  ...
  <div class="box4" style="margin-top:20px">
   ...
   <div class="container2">
    <div v-click class="mini-container">Convert a given double value 78.99 to int.</div>
    <div v-click class="mini-container">Convert a given long value 500000L to int.</div>
    <div v-click class="mini-container">Convert a given double value 190.45 to byte.</div>
    <div v-click class="mini-container">Convert a given int value 68 to char.</div>
   </div>
  </div>
</div>
