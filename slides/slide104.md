...
<div class="box1">
  ...
  <div class="box4" style="margin-top:20px">
   ...
   <div class="container2">
    <div v-click class="mini-container">Display `Hello world!` using <b>println</b> method</div>
    <div v-click class="mini-container">Display `Hello World` using <b>print</b> method</div>  
    <div v-click class="mini-container">Display `Hello World` using <b>printf</b> method</div>
   </div>
  </div>
</div>
